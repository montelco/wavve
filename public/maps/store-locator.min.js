(function($) {
    ...
    */
    ...
    storeLocator.GMEDataFeed.prototype.parse_ = function(a) {
        if (a.error)
            return window.alert(a.error.message), [];
        a = a.features;
        if (!a)
            return [];
    ...
    storeLocator.StaticDataFeed.prototype.getStores = function(a, b, c) {
        if (this.stores_.length) {
            for (var d = [], e = 0, f; f = this.stores_[e]; e++)
                f.hasAllFeatures(b) && d.push(f);
    ...
    */
    ...
    storeLocator.Store.prototype.generateFeaturesHTML_ = function() {
        ...
        for (var b = this.features_.asList(), c = 0, d; d = b[c]; c++)
            a.push("\x3cli\x3e"), a.push(d.getDisplayName()), a.push("\x3c/li\x3e");
        a.push("\x3c/ul\x3e");
        return a.join("")
    };
    ...
    storeLocator.View.prototype.getFeatureById = function(a) {
        if (!this.featureById_) {
            this.featureById_ = {};
            for (var b = 0, c; c = this.settings_.features[b]; b++)
                this.featureById_[c.getId()] = c
        }
        ...
        this.data_.getStores(this.getMap().getBounds(), this.get("featureFilter"), function(b) {
            ...
            if (c)
                for (var d = 0, e = c.length; d < e; d++)
                    google.maps.event.removeListener(c[d].getMarker().clickListener_);
            a.set("stores", b)
        })
    };
