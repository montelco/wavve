            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li id="usr_controls_boundary">
                    <a href="javascript:;" data-toggle="collapse"
                       data-target="#integrated_usr_controls"> {{ Auth::user()->name }} <i
                                class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="integrated_usr_controls" class="collapse">
                        <li>
                            <a href="{{ url('/logout') }}"><i class="fa fa-btn fa-power-off fa-fw"></i>&nbsp;Logout</a>
                        </li>
                        <li>
                            <a href="{{ url('/settings') }}"><i class="fa fa-btn fa-cog fa-fw"></i>&nbsp;Settings</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="{{ url('/dashboard') }}"><i class="fa fa-fw fa-dashboard fa-fw"></i>&nbsp;Dashboard
                        Home</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#pass_manager_well" aria-expanded="true"><i
                                class="fa fa-fw fa-tags"></i> Manage Passes <i class="fa fa-fw fa-caret-down"></i></a>
