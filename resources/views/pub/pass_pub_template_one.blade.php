...
@section('strip_pass_contents')
    ...
    <div id="public-pass">
        ...
        <div class="center-align">
            <h4 class="pass-title"> {{$pass->title}} </h4>
            <div class="divider"></div>
        </div>

        <div class="pass-details">
            @if(isset($pass->expiry) && $pass->expiry != '0000-00-00 00:00:00')
                <p class="expiry pass-text">
                    Exp: {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $pass->expiry)->format('D, M j Y') }}</p>
            @endif
            ...
            <div id="redeem-modal" class="modal modal-fixed-footer modal-wrapper">
                <div class="modal-content">
                    ...
                    <div class="center-align">
                        ...
                        <p class="promo-code promo-code-modal pass-text">FREEAPRIL17</p>
                    </div>
                    @if(isset($pass->expiry) && $pass->expiry != '0000-00-00 00:00:00')
