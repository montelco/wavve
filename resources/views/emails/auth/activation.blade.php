...
<a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="http://wavvve.app" target="_blank">
Wavvve
</a>
</td>
</tr>
...
You are receiving this email so you can activate your account.
</p>
...
<a href="{{ route('auth.activate', $token) }}"
...
If you’re having trouble clicking the "Activate Account" button,
copy and paste the URL below into your web browser:
</p>

<p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
<a style="color: #3869D4;" href="{{ route('auth.activate', $token) }}" target="_blank">
...
<p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
&copy;
<a style="color: #3869D4;" href="{{ url('/') }}" target="_blank">Wavvve</a>.
All rights reserved.
</p>
</td>
</tr>
